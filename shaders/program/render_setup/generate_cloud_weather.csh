...
void main(){
  ...
  float worley_1 = max0(linearstep(0.6  * ((1.0 - ap.world.rain * 1.5) * 0.3 + 0.7), 1.0, (1.0 - pow2(sample_worley_noise(vec3(coord * vec2(1.0, 1.0), 0.0), 16, 32, 3, 1)))));
  float worley_2 = max0(linearstep(0.6 * (1.0 - ap.world.rain * 1.5), 1.0, (1.0 - pow2(sample_worley_noise(vec3(coord.yx * vec2(1.0, 1.0), 0.0), 32, 16, 3, 1))))) + 0.5 * ap.world.rain;
