...
void main(){
  ...
  float worley_1 = max0(linearstep(0.6 * (1.0 - ap.world.rain * 1.5), 1.0, (1.0 - pow2(sample_worley_noise(vec3(coord * vec2(1.0, 1.5), 0.0), 16, 32, 3, 1)))));
  ...
  imageStore(cloud_weather, ivec2(gl_GlobalInvocationID.xy), vec4(worley_1, 0.0, 0.0, 1.0));
}