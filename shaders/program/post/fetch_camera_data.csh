...
void main() {
  ...
  const float day_average_luminance = pow(170.0/255.0, GAMMA);
  const float night_average_luminance = pow(33.0/255.0, GAMMA);
  const float underground_average_luminance = 0.5;
